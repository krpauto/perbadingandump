        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <!-- /.box-header -->
                    <div class="box-body">
                        <form action="<?php echo base_url('odp/upd'); ?>" method="POST" enctype="multipart/form-data">
                            <div class="row">
                                <input type="hidden" class="form-control" value="<?= $odp->id_odp; ?>" name="id_odp">
                                <input type="hidden" name="foto_old" value="<?= $odp->foto; ?>">
                                <div class="col-sm-6">
